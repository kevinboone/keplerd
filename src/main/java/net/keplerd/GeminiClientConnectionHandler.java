/*===========================================================================
  ...
  GeminiClientConnectionHandler.java
...
public class GeminiClientConnectionHandler implements ClientConnectionHandler
  {
  ...
  public void handleClientConnection (ServerConfig sc, Socket clientSocket, String userIdent)
    ...
    try 
      ...
      resp = new GeminiResponseImpl (out);
      Handler handler = GeminiHandler.getHandler (sc, req);
