/*===========================================================================
  ...
  KeplerClientConnectionHandler.java
...
public class KeplerClientConnectionHandler implements ClientConnectionHandler
  {
  ...
  public void handleClientConnection (ServerConfig sc, Socket clientSocket, String userIdent)
    ...
    try 
      ...
      resp = new KeplerResponseImpl (out);
      Handler handler = KeplerHandler.getHandler (sc, req);
      ...
      {
      Logger.warn ("IO Exception while handling request: " + e );
      }
    finally
      {
      clientSocket.close();
