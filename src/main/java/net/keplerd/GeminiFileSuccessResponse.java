/*===========================================================================
  ...
  GeminiFileSuccessResponse.java
...
public class GeminiFileSuccessResponse extends GeminiResponse
  {
  private File file;
  ...
  /** Should not construct this class unless we're sure the file
      ...
      from here. 
  */
  public GeminiFileSuccessResponse (File file)
    {
    this.file = file;
    }
